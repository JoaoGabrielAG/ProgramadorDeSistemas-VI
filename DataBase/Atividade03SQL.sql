...
SELECT a.nome, a.idade, c.nome FROM alunos AS a
INNER JOIN cursos AS c ON c.id = a.curso_id;

SELECT a.nome, a.cidade, c.nome, c.carga_horaria FROM alunos AS a
INNER JOIN cursos AS c ON c.id = a.curso_id;
...
SELECT a.nome, c.nome AS curso, c.carga_horaria FROM alunos AS a
INNER JOIN cursos AS c ON c.id = a.curso_id
